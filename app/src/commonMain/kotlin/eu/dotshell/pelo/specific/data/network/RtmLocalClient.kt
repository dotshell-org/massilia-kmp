...
import eu.dotshell.pelo.specific.data.local.RtmLine
import eu.dotshell.pelo.specific.data.local.RtmLinesParser
 ...
 *   same `"<line>:A,<line>:R"` format that [eu.dotshell.pelo.generic.data.repository.itinerary.itinerary.RaptorRepository.getDesserteForStop]
 *   produces, so [eu.dotshell.pelo.generic.utils.graphics.LineIconResolver.parseDesserte] works unchanged.
