package eu.dotshell.massilia.generic.data.network.geocoding

import eu.dotshell.massilia.generic.data.network.PUBLIC_SERVICES_USER_AGENT
...
class PhotonGeocodingClient {
    ...
    companion object {
        ...
        // Location bias: results near Marseille rank first (hard filtering happens in the repository)
        private const val BIAS_LAT = 43.2965
        private const val BIAS_LON = 5.3698
    }
}
