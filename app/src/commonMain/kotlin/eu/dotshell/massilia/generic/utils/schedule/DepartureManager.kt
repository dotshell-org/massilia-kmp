package eu.dotshell.massilia.generic.utils.schedule
...
object DepartureManager {
    ...
    @Composable
    fun formatRelativeDeparture(departureTime: String, strings: eu.dotshell.massilia.platform.StringProvider): String? {
