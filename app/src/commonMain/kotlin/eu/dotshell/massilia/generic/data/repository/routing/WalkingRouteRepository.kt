package eu.dotshell.massilia.generic.data.repository.routing

import eu.dotshell.massilia.generic.data.network.routing.OsrmRouteResponse
import eu.dotshell.massilia.generic.data.network.routing.OsrmWalkingClient
