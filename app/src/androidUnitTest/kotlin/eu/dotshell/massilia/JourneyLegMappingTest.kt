...
import eu.dotshell.massilia.generic.data.cache.journey.SerializableJourneyLeg
import eu.dotshell.massilia.generic.data.repository.itinerary.itinerary.JourneyLegKind
import eu.dotshell.massilia.generic.data.repository.itinerary.itinerary.mapLibraryJourneys
...
class JourneyLegMappingTest {
    ...
    fun coordinateWalkLegsAreMappedWithLabelsNotDropped() {
        ...
        val results = mapLibraryJourneys(
            ...
            destinationLabel = "Carrefour Bonneveine"
        )
        ...
        assertEquals("Carrefour Bonneveine", legs[2].toStopName)
