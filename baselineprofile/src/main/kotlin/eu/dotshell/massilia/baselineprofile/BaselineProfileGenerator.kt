package eu.dotshell.massilia.baselineprofile
...
/**
 * Captures a Baseline Profile for Massilia's cold-start critical path.
 *
...
class BaselineProfileGenerator {
    ...
    @Test
    fun generate() = rule.collect(packageName = "eu.dotshell.massilia") {
